...
task("MintWithCondition", "MintWithCondition for user")
    .addParam("contractaddress", "The SimpleCoin address")
    .addParam("user", "which id would you want")
    .addParam("amount","")
    .addParam("point", "The account to send to")
    .setAction(async (taskArgs) => {
        ...
        try {
            result = await simpleCoinContract.MintWithCondition(user,amount,point, {
                gasLimit: 1000000000,
